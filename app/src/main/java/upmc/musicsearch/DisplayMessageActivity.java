...
import upmc.musicsearch.pojos.Release;
...
public class DisplayMessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set messageView and editMessage (display_message and modify_message ids)
         ...
         editMessage =  (EditText) findViewById(R.id.modify_message);

        //set releaseLayout (releases_list id)
         releaseLayout = (LinearLayout) findViewById(R.id.releases_list);

        //get the unique Volley's Request Queue instancce
        // queue = // ??
    ...
    private void loadMusicDataFromIntent() {
        ...
        //get the message from the intent
         String mbid = intent.getStringExtra("message");
